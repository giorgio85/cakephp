...
<head>
    ...
    echo $this->Html->script(['jquery-1.11.1.min', 'jquery.mobile-1.4.5', 'cakerecipe', 'info']);
    ...
    <div data-role="page" data-theme="a">
        <div data-role="header" data-position="fixed">
            ...
            <div class="ui-btn-left" data-role="controlgroup" data-type="horizontal">  
                <?php
                if ($this->fetch('title') != 'Información'):
                    echo $this->Html->link('Login', ['controller' => 'pages', 'action' => '#left-panel'], ['data-role' => 'button', 'data-icon' => 'info', 'data-iconpos' => 'notext']);
                endif;
                ?>
                <?php if ($this->fetch('title') != 'Página principal'): ?>
        ...
        <?php
        if (($this->fetch('title') == 'Perfil de usuario') || ($this->fetch('title') == 'Editar perfil') || ($this->fetch('title') == 'Mis imágenes') || ($this->fetch('title') == 'Mis pedidos')) :
            ?>
            <div data-role="footer" data-position="fixed" data-theme="a">
                <div data-role="navbar">
                    <ul>
                        <li><a href="/cakephp/users/profile" class="ui-btn-icon-top ui-icon-eye<?php if ($this->fetch('title') == 'Perfil de usuario') echo " ui-btn-active"; ?>">Perfil</a></li>
                        <li><a href="/cakephp/users/orders" class="ui-btn-icon-top ui-icon-shop<?php if ($this->fetch('title') == 'Mis pedidos') echo " ui-btn-active"; ?>">Pedidos</a></li>
                        <li><a href="/cakephp/users/posts" class="ui-btn-icon-top ui-icon-camera<?php if ($this->fetch('title') == 'Mis imágenes') echo " ui-btn-active"; ?>">Imágenes</a></li>
                    </ul>
                </div>
            </div>
        <?php endif; ?>
